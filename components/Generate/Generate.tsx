...
function Generate() {
  ...
  return (
    <div className={classnames("w-[26rem] mt-20", josefinSans.className)}>
      {show && (
        <Certificate
          name={name}
          school={school}
      ...
      <form
        ...
        <button
          type="submit"
          className="text-l font-bold hover:bg-black hover:text-gray-200 transition ease-in-out duration-300  !mt-10 bg-[#F7F24D] border-[#F7F24D] rounded-full text-gray-800 border w-48 h- mx-auto">
          GENERATE
        </button>
      </form>
    </div>
